      ...
      <div className={styles.content}>
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            персональных данных пользователей сайта dilavia.by (далее — «Сайт») компанией Dilavia 
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>Данные о взаимодействии с сайтом (страницы, время посещения)</li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>7. Права субъектов персональных данных</h2>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>8. Cookies и аналогичные технологии</h2>
          <p className={styles.text}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            О существенных изменениях мы будем уведомлять вас через сайт или 
        ...
        <section className={styles.section}>
          ...
          <div className={styles.contactInfo}>
            <p><strong>Email:</strong> privacy@dilavia.by</p>
            <p><strong>Телефон:</strong> +375 (29) 123-45-67</p>
            <p><strong>Адрес:</strong> Республика Беларусь, г. Минск</p>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.text}>
            Данная Политика вступает в силу с момента ее размещения на сайте 
            и действует до момента принятия новой редакции.
          </p>
          <p className={styles.text}>
