...
import { PrivacyPageSchema } from "@/components/schema";
        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              сайта dilavia.by (далее — «Сайт») компанией Dilavia (далее —
              «Компания», «мы», «нас», «наш»).
            </p>
            <p className={styles.text}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              ...
              <li>
                Для выполнения заказа (службы доставки, платежные системы)
              </li>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              пользовательского опыта, анализа трафика и персонализации
              контента.
            </p>
            <p className={styles.text}>
              Вы можете управлять настройками cookies в вашем браузере. Обратите
              внимание, что отключение cookies может повлиять на
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>
              Рекомендуем периодически знакомиться с актуальной версией
              Политики.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.contactInfo}>
              <p>
                <strong>Email:</strong> infomiagkhikomfort@gmail.com
              </p>
              <p>
                <strong>Телефон:</strong> +375 (33) 664-18-30
              </p>
              <p>
                <strong>Адрес:</strong> БЕЛАРУСЬ, г. Минск, ул. Железнодорожная
                33А, оф. 402.
              </p>
            </div>
          </section>
