...
export const metadata: Metadata = {
  ...
  description: 'Широкий ассортимент качественной мебели: кровати, диваны, кресла, столы и многое другое. Доставка по всей Беларуси.',
  keywords: 'мебель, кровати, диваны, кресла, столы, шкафы, каталог, купить мебель',
  openGraph: {
