          ...
          <div className={styles.titleRow}>
            <div>
              ...
              <div className={styles.description}>
                {description ||
                  "В интернет-магазине Dilavia.by представлены только тщательно отобранные модели диванов, мягкой мебели. Каждая модель из нашего интернет каталога – это воплощение отличного дизайна."}
              </div>
            </div>
