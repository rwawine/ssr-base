            ...
            <div className={styles.header__wrapper}>
                <div className={styles.header__content}>
                    ...
                    <div className={styles.header__logo} tabIndex={0}>
                        <Link href="/" title="Dilavia - Главная страница"> Dilavia</Link>
                    </div>

                    {/* Навигация */}
                    <nav className={styles.header__navigation}>
                        <Link className={styles.header__link} href="/" title="Перейти на главную страницу">Главная</Link>
                        <div
                        ...
                        >
                            <div className={styles.header__link}>
                                <Link href="/catalog" className={styles.header__link_text} title="Перейти в каталог товаров">Каталог</Link>
                                <div
                                    ...
                                    <div className={`${styles.expander} ${styles.menu_expander}`}>
                                        <div className={styles.menu_expander__content}>
                                            {navMenuItems.map((item, index) => (
                                                <Link key={index} href={item.url} className={styles.menu_expander__item} title={`Перейти в раздел ${item.title}`}>
                                                    {item.title}
                                                </Link>
                                            ))}
                                        </div>
