...
const SortIcon = () => (
  ...
  >
    <path
      d="M3 18H7V16H3V18ZM3 6V8H21V6H3ZM3 13H15V11H3V13Z"
      fill="currentColor"
    />
  </svg>
);
...
const CategoryIcon = () => (
  ...
  >
    <path
      d="M10 4H4C2.89 4 2 4.89 2 6V18C2 19.11 2.89 20 4 20H10V4M12 4V20H20C21.11 20 22 19.11 22 18V6C22 4.89 21.11 4 20 4H12Z"
      fill="currentColor"
    />
  </svg>
);
...
export default function CatalogFilters({
  ...
  const selectedCategoryData = categories.filter((cat) =>
    (filters.category || []).includes(cat.code),
  );
  const showSubcategorySection = selectedCategoryData.some(
    (cat) => cat.subcategories.length > 1,
  );
              ...
              <div className={styles.sectionContent}>
                ...
                <div className={styles.priceSlider}>
                  ...
                  <input
                    ...
                    value={priceRange[0]}
                    onChange={(e) =>
                      handlePriceSlider(0, Number(e.target.value))
                    }
                  ...
                  <input
                    ...
                    value={priceRange[1]}
                    onChange={(e) =>
                      handlePriceSlider(1, Number(e.target.value))
                    }
                    className={styles.rangeSlider}
                  />
                </div>
                      ...
                      .map((subcategory) => (
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              handleSubcategoryChange(subcategory.code)
                            }
                          />
                          <span className={styles.checkboxCustom}></span>
